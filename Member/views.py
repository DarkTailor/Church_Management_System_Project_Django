...
class DownloadCSVViewMember(View):
    def get(self, request, *args, **kwargs):
        # Fetch data from your model
        queryset = Member.objects.all()  # Replace with your actual queryset
        ...
        writer.writerow(['name', 'surname', 'category', 'birthday', 'email'])  # Replace with your actual field names
        for item in queryset:
            writer.writerow([item.name, item.surname, item.category, item.birthday, item.email])  # Use the actual attribute names
