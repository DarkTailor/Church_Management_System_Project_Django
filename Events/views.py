...
class DownloadCSVViewEvents(View):
    def get(self, request, *args, **kwargs):
        # Fetch data from your model
        queryset = Events.objects.all()  # Replace with your actual queryset
        ...
        writer.writerow(['Event', 'Date', 'Time'])  # Replace with your actual field names
        for item in queryset:
            writer.writerow([item.Event, item.Date, item.Time])  # Use the actual attribute names
